    ...
    for r in range(6):
        ...
        for a in range(3):
            ...
            tr1 = np.trace(
                rspmats_1[c, ...]
                .dot(rspmats_1[b, ...])
                .dot(-epsilon_2[a, ...].T)[:nocc_alph, :nocc_alph]
            )
            tr2 = np.trace(
                rspmats_1[b, ...]
                .dot(rspmats_1[c, ...])
            ...
            tr3 = np.trace(
                rspmats_1[c, ...]
                .dot(rspmats_2[a, ...].T)
                .dot(epsilon_1[b, ...])[:nocc_alph, :nocc_alph]
            )
            tr4 = np.trace(
                rspmats_2[a, ...]
                .T.dot(rspmats_1[c, ...])
            ...
            tr5 = np.trace(
                rspmats_1[b, ...]
                .dot(rspmats_2[a, ...].T)
                .dot(epsilon_1[c, ...])[:nocc_alph, :nocc_alph]
            )
            tr6 = np.trace(
                rspmats_2[a, ...]
                .T.dot(rspmats_1[b, ...])
    ...
    for r in range(6):
        ...
        for a in range(3):
            ...
            tr5 = np.trace(
                rspmats_1[b, ...]
                .dot(rspmats_2[a, ...].T)
                .dot(epsilon_2[c, ...])[:nocc_alph, :nocc_alph]
            )
            tr6 = np.trace(
                rspmats_2[a, ...]
                .T.dot(rspmats_1[b, ...])
    ...
    for r in range(6):
        ...
        for a in range(3):
            ...
            tr1 = np.trace(
                rspmats_2[c, ...]
                .T.dot(rspmats_2[b, ...])
                .dot(epsilon_1[a, ...])[:nocc_alph, :nocc_alph]
            )
            tr2 = np.trace(
                rspmats_2[b, ...]
                .dot(rspmats_2[c, ...].T)
            ...
            tr3 = np.trace(
                rspmats_2[c, ...]
                .T.dot(rspmats_1[a, ...])
                .dot(epsilon_2[b, ...])[:nocc_alph, :nocc_alph]
            )
            tr4 = np.trace(
                rspmats_1[a, ...]
                .dot(rspmats_2[c, ...].T)
            ...
            tr5 = np.trace(
                rspmats_2[b, ...]
                .dot(rspmats_1[a, ...])
                .dot(-epsilon_2[c, ...].T)[:nocc_alph, :nocc_alph]
            )
            tr6 = np.trace(
                rspmats_1[a, ...]
                .dot(rspmats_2[b, ...])
