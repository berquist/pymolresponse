...
def test_first_hyperpolarizability_eope_rhf_wigner_explicit() -> None:
    ...
    ref_avgs = np.array([6.34718216, -7.81453502, 4.39980948])  # ruff: ignore[unused-variable]
    ref_avg = 10.98690140  # ruff: ignore[unused-variable]
...
def test_first_hyperpolarizability_or_rhf_wigner_explicit() -> None:
    ...
    ref_avgs = np.array([6.34331713, -7.81628395, 4.40251201])  # ruff: ignore[unused-variable]
    ref_avg = 10.98699590  # ruff: ignore[unused-variable]
