...
from explicit_equations_partial import (form_rpa_a_matrix_mo_singlet,
...
def test_explicit_uhf_outside_solver():
    ...
    tei_mo_ovov_aaaa = ao2mo.general(mol, C_ovov_aaaa, aosym='s1', compact=False, verbose=5).reshape(nocc_a, nvirt_a, nocc_a, nvirt_a)
    tei_mo_ovov_aabb = ao2mo.general(mol, C_ovov_aabb, aosym='s1', compact=False, verbose=5).reshape(nocc_a, nvirt_a, nocc_b, nvirt_b)
    tei_mo_ovov_bbaa = ao2mo.general(mol, C_ovov_bbaa, aosym='s1', compact=False, verbose=5).reshape(nocc_b, nvirt_b, nocc_a, nvirt_a)
    tei_mo_ovov_bbbb = ao2mo.general(mol, C_ovov_bbbb, aosym='s1', compact=False, verbose=5).reshape(nocc_b, nvirt_b, nocc_b, nvirt_b)
    tei_mo_oovv_aaaa = ao2mo.general(mol, C_oovv_aaaa, aosym='s1', compact=False, verbose=5).reshape(nocc_a, nocc_a, nvirt_a, nvirt_a)
    tei_mo_oovv_bbbb = ao2mo.general(mol, C_oovv_bbbb, aosym='s1', compact=False, verbose=5).reshape(nocc_b, nocc_b, nvirt_b, nvirt_b)

    A_s_ss_a = form_rpa_a_matrix_mo_singlet_ss(E_a, tei_mo_ovov_aaaa, tei_mo_oovv_aaaa)
    A_s_os_a = form_rpa_a_matrix_mo_singlet_os(tei_mo_ovov_aabb)
    B_s_ss_a = form_rpa_b_matrix_mo_singlet_ss(tei_mo_ovov_aaaa)
    B_s_os_a = form_rpa_b_matrix_mo_singlet_os(tei_mo_ovov_aabb)
    A_s_ss_b = form_rpa_a_matrix_mo_singlet_ss(E_b, tei_mo_ovov_bbbb, tei_mo_oovv_bbbb)
    A_s_os_b = form_rpa_a_matrix_mo_singlet_os(tei_mo_ovov_bbaa)
    B_s_ss_b = form_rpa_b_matrix_mo_singlet_ss(tei_mo_ovov_bbbb)
    B_s_os_b = form_rpa_b_matrix_mo_singlet_os(tei_mo_ovov_bbaa)
