...
BC2H4_HF_STO3G_RPA_singlet_nwchem = {
    # from minimal
    0.0 : {
        'polar': np.array([[16.0702163, -4.9832488, -2.2293822],
                           [-4.9832488, 13.1502378, 0.2844524],
                           [-2.2293822, 0.2844524, 18.1993490]]),
    },
    # from orbeta
    0.001 : {
        'polar': np.array([[16.0702789, -4.9832818, -2.2293882],
                           [-4.9832818, 13.1502964, 0.2844393],
                           [-2.2293882, 0.2844393, 18.1994070]]),
        'orbeta': np.array([[-1.7067, -5.8002, -2.9465],
                            [7.2404, 0.9278, 5.3503],
                            [4.9573, -0.5056, -3.3741]]),
    },
    # from orbeta
    0.0773178 : {
        'polar': np.array([[16.4963293, -5.2448779, -2.2476469],
                           [-5.2448779, 13.6064856, 0.1637870],
                           [-2.2476469, 0.1637869, 18.5823648]]),
        'orbeta': np.array([[-1.4712, -5.3345, -4.2604],
                            [6.4702, 0.3833, 8.8611],
                            [5.6097, -0.4006, -5.0196]]),
    },
    # from orbeta
    0.128347 : {
        'polar': np.array([[15.3394615, -2.0395326, -3.7937930],
                           [-2.0395327, 7.7254042, 2.6104237],
                           [-3.7937933, 2.6104240, 18.3446840]]),
        # Flipped the sign on the [2, 1] element.
        'orbeta': np.array([[-17.0050, -8.6288, 53.2469],
                            [33.1190, 7.7765, -90.7071],
                            [-4.0315, -3.5893, 34.0186]]),
    },
}
...
trithiolane_HF_STO3G_RPA_singlet = {
    0.0 : {
        'polar': np.asarray([[3.47899000e+01, -1.77591000e-05, 2.24416000e-04],
                             [-1.77591000e-05, 4.43286000e+01, -1.91191000e-01],
                             [2.24416000e-04, -1.91191000e-01, 1.68476000e+01]]),
        'dipmag': np.asarray([[-0.854380e+01, -0.279465e-02, 0.693947e-03],
                              [-0.537619e-02, 0.125637e+02, -0.447617e+01],
                              [0.281657e-02, -0.985703e+01, -0.506194e+01]]),
    },
    0.0773178 : {
        'polar': np.asarray([[3.53972000e+01, -8.48249000e-06, 2.05118000e-04],
                             [-8.48249000e-06, 4.52552000e+01, -2.17003000e-01],
                             [2.05118000e-04, -2.17003000e-01, 1.70848000e+01]]),
        'dipmag': np.asarray([[-0.873446e+01, -0.291464e-02, 0.749139e-03],
                              [-0.546200e-02, 0.129058e+02, -0.453107e+01],
                              [0.290515e-02, -0.105516e+02, -0.537653e+01]]),
    },
    0.128347 : {
        'polar': np.asarray([[3.65252000e+01, -2.36748000e-06, 1.76171000e-04],
                             [-2.36748000e-06, 4.70314000e+01, -2.86868000e-01],
                             [1.76171000e-04, -2.86868000e-01, 1.75452000e+01]]),
        'dipmag': np.asarray([[-0.908406e+01, -0.315108e-02, 0.843565e-03],
                              [-0.563037e-02, 0.135977e+02, -0.466676e+01],
                              [0.306764e-02, -0.118891e+02, -0.609620e+01]]),
    },
}
...
def test_ORD_RPA_singlet_BC2H4_cation_HF_STO3G():
    ...
    ord_solver = optrot.ORD(pyscfmol, C, E, occupations, frequencies=frequencies, do_dipvel=False)
