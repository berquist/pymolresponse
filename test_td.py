...
from molecules import molecule_LiH_cation_HF_STO3G
...
def test_LiH_cation_both_singlet_HF_STO3G():
    ...
    tda = TDA(C, E, occupations)
    tdhf = TDHF(C, E, occupations)
    tei_mo = ao2mo.perform_tei_ao2mo_uhf_partial(mol, C, mol.verbose)
    tda.tei_mo = tei_mo
    tda.tei_mo_type = 'partial'
    tdhf.tei_mo = tei_mo
    tdhf.tei_mo_type = 'partial'
...
def test_HF_cation_both_singlet_HF_STO3G():
    mol = pyscf.gto.Mole()
    mol.verbose = 5
    mol.output = None
...
if __name__ == '__main__':
    ...
    # test_HF_cation_both_singlet_HF_STO3G()
    test_LiH_cation_both_singlet_HF_STO3G()
